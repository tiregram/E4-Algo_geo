...
public:
  ...
  double dist(const myPoint3D& p1, const myPoint3D& p2);
  double dist(const myPoint3D& p1, const myVector3D& v2);
  double dist(const myPoint3D& p1, const myPoint3D& p2, const myPoint3D& p3);
